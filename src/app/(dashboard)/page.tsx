...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700 perspective-container">
      <div className="pt-20 flex flex-col items-center justify-center mb-12 animate-in zoom-in-95 duration-700">
        ...
        <div className="space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 font-medium italic">
              Gestão de alta performance no <span className="text-primary font-bold">UniRH Elite</span>
            </p>
          </div>
        </div>
      </div>
